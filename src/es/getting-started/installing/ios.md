...
Descarga y hazle un sideload (descarga lateral) a <a :href="`https://download.sonolus.com/Sonolus_${version.link}.ipa`" target="_blank" rel="noreferrer">Sonolus\_{{ version.link }}.ipa</a> usando cualquiera de esas herramientas.
...
Descarga y hazle un sideload (descarga lateral) a <a :href="`https://download.sonolus.com/Sonolus_${version.link}.ipa`" target="_blank" rel="noreferrer">Sonolus\_{{ version.link }}.ipa</a> usando cualquiera de esos servicios.
...
Descarga e instala <a :href="`https://download.sonolus.com/Sonolus_${version.link}.ipa`" target="_blank" rel="noreferrer">Sonolus\_{{ version.link }}.ipa</a> después de hacer un jailbreak.
