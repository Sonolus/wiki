...
Lade <a :href="`https://download.sonolus.com/Sonolus_${version.link}.ipa`" target="_blank" rel="noreferrer">Sonolus\_{{ version.link }}.ipa</a> herunter und nutze eine der bereits erwähnten Anwendungen oder ähnliches.
...
Lade <a :href="`https://download.sonolus.com/Sonolus_${version.link}.ipa`" target="_blank" rel="noreferrer">Sonolus\_{{ version.link }}.ipa</a> herunter und nutze eine der bereits erwähnten Dienste oder ähnliches.
...
Lade <a :href="`https://download.sonolus.com/Sonolus_${version.link}.ipa`" target="_blank" rel="noreferrer">Sonolus\_{{ version.link }}.ipa</a> nach dem jailbreaken herunter und installiere die App.
