...
- [JS + Oxlint + Oxfmt](https://github.com/Sonolus/sonolus.js-template-js-oxlint-oxfmt)
- [TS](https://github.com/Sonolus/sonolus.js-template-ts)
- [TS + Oxlint + Oxfmt](https://github.com/Sonolus/sonolus.js-template-ts-oxlint-oxfmt)

Misalnya, untuk menggunakan templat [TS + Oxlint + Oxfmt](https://github.com/Sonolus/sonolus.js-template-ts-oxlint-oxfmt) :

```shell
npx degit Sonolus/sonolus.js-template-ts-oxlint-oxfmt my-project
