...
Judgment life increment applies for judgment hit, as long as the level is not failed. For example for a particular entity, a Miss life increment of `-100` will result in reducing player life by `100` upon a Miss on this archetype.
